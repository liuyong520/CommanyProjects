 ...
 */
public class UnRechargeRequest extends HttpData implements Request{
    ...
    public UnRechargeRequest(String merchantNo, String unslowIntOrderId, String sendorderId, String rechargeType, String rechargeNum, String rechargeValue) {
        this.merchantNo = merchantNo;
        this.unslowIntOrderId = unslowIntOrderId;
        this.sendorderId = sendorderId;
        this.rechargeType = rechargeType;
    ...
    public String toString() {
        return "UnRechargeRequest{" +
                ...
                ", unslowIntOrderId='" + unslowIntOrderId + '\'' +
